...
<html lang="en">
  ...
  <body>
    ...
    <header class="border-bottom">
        <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #f3e4a8;">
        <div class="container-fluid py-2">
            ...
            <!-- Navigation Links -->
            <ul
                class="navbar-nav mx-auto mb-2 mb-lg-0 fw-bold text-uppercase text-dark d-flex gap-lg-4"
            >
                <li class="nav-item">
                ...
                <li class="nav-item">
                <a class="nav-link" href="index.php#OurFarms">Our Farms</a>
                </li>
                <li class="nav-item">
            ...
            <!-- Icons -->
            <ul
                class="navbar-nav d-flex flex-row align-items-center gap-3 mt-3 mt-lg-0"
            >
                <li class="nav-item">
